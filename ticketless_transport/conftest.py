...
from ticketless_transport.db.dependencies import get_db_session
from ticketless_transport.db.utils import create_database, drop_database
from ticketless_transport.services.rabbit.dependencies import get_rmq_channel_pool
from ticketless_transport.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from ticketless_transport.settings import settings
from ticketless_transport.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from ticketless_transport.db.meta import meta  # noqa: WPS433
    from ticketless_transport.db.models import load_all_models  # noqa: WPS433
